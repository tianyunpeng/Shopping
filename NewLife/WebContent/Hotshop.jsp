        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
					...
					<li class="active"><a href="userBookList1.do">热门商品</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-pagination text-center">
                        <nav>
                        <a href="userBookList1.do?pageS=1">首页</a>&nbsp;&nbsp;&nbsp;
						<c:if test="${page.dpage!=1}">
						<a href="userBookList1.do?pageS=${page.dpage-1}">上一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${page.dpage!=page.totalpage}">
						<a href="userBookList1.do?pageS=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<a href="userBookList1.do?pageS=${page.totalpage}">尾页</a>
                        </nav>                        
                    </div>
                </div>
            </div>
