        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
					...
					<li class="active"><a href="userBookList2.do">最新商品</a></li>
					<li><a href="inquiry.jsp">搜索</a></li>
					<li><a href="#">更多</a></li>
				</ul>
                </div>  
            </div>
                ...
                <div class="col-md-3 col-sm-6" float:left>
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img alt="图片" src="${book.imgUrl}">
                        </div>
                        <h2><a href="">${book.name}</a></h2>
                        <h3>${book.author}</h3>
                        <div class="product-carousel-price">
                            <ins>${book.price}</ins> <del>${book.price+10}</del>
                        </div>  
                        
                        <div class="product-option-shop">
                      
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="addCart.do?id=${book.bookId}">Add to cart</a>
                        </div>                       
                    </div>
                </div>
                </c:forEach> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-pagination text-center">
                        <nav>
                          <a href="userBookList2.do?pageS=1">首页</a>&nbsp;&nbsp;&nbsp;
						<c:if test="${page.dpage!=1}">
						<a href="userBookList2.do?pageS=${page.dpage-1}">上一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${page.dpage!=page.totalpage}">
						<a href="userBookList2.do?pageS=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<a href="userBookList2.do?pageS=${page.totalpage}">尾页</a>
                        </nav>                        
                    </div>
                </div>
            </div>
