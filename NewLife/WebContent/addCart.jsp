	...
	<div class="container">
		...
		<div class="main-bar">
			<table class="table table-hover table-striped" align="center" width="100%" border="10">			
                                <form modelAttribute="book" action="addBookCart.do" method="post" enctype="multipart/form-data">                     
                                      ...
                                      <tr align="center">
										...
										<td>${book.name}</td>
										<td>${book.author}</td>
										<td><input type="text" id="text2" name="text2"onkeyup="jisuan();" value="${book.price}"readonly="readonly"style="width:40px;"disabled="true"/></td>
								...
								<form action="addBookCart.do">
									<input type="hidden" name="ids" value="${book.bookId}">
