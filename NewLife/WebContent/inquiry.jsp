...
<link href='http://fonts.googleapis.com/css?family=Raleway:400,100' rel='stylesheet' type='text/css'>--->    
  ...
  <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
					...
					<li class="active"><a href="inquiry.jsp">搜索</a></li>
					<li><a href="#">更多</a></li>
				</ul>
                </div>  
            </div>
    ...
    <div class="single-product-area">
        ...
        <div class="container">
            <div class="row">     
           						<form action="findBookId.do" method="post">
               						<input type="text" name="bookId"/>
               						<input type="submit" value="输入书籍id以搜索">
               					</form><br/>
               					
               					<form action="findBookKid.do" method="post">
               						<input type="text" name="bookKid"/>
               						<input type="submit" value="输入类别id以搜索">
               					</form><br/>tip&nbsp;:&nbsp;图书类别1为文学类书籍，2为科学类书籍，3为计算机类书籍。
            </div>
            <div class="row">
                <div class="col-md-12">
