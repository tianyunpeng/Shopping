...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                				<form action="adminFindName.do" method="post">
               						<input type="text" name="name"/>
               						<input type="submit" value="输入商品名称搜索订单">
               					</form>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped" align="center">
                                    ...
                                    <tbody>
										...
										<td><a href="detailsOrders.do?id=${orders.orderId}">订单详情</a>
										<a href="confirmOrders.do?id=${orders.orderId}">确认订单</a></td>
									  </tr>
            ...
            <div class="container-fluid">
              	<tr>
              		<td colspan="7" align="center">
						<a href="ordersList.do?pageS=1">首页</a>&nbsp;&nbsp;&nbsp;
						<c:if test="${page.dpage!=1}">
						<a href="ordersList.do?pageS=${page.dpage-1}">上一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${page.dpage!=page.totalpage}">
						<a href="ordersList.do?pageS=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<a href="ordersList.do?pageS=${page.totalpage}">尾页</a>
					</td>
				</tr>
            </div>
        </footer>
