			...
			<table class="table table-hover table-striped" align="center" width="100%" border="10">			
                                <form modelAttribute="cart" enctype="multipart/form-data">                     
                                      ...
                                      <tr align="center">                  
										...
										<td>${cart.name}</td>
										<td>${cart.author}</td>
										<td><input type="text" id="text2" name="text2"onkeyup="jisuan();" value="${cart.price}"readonly="readonly"style="width:40px;"disabled="true"/></td>
									  </tr>
								</form>
								...
								<form action="updateCart2.do">
									<input type="hidden" name="ids" value="${cart.cartId}">
